...
public class SpEntityId extends SamlProperty {
    ...
    public SpEntityId(@CheckForNull String value) {
        this.value = Objects.requireNonNull(Util.fixEmptyAndTrim(value), "SP Entity ID must not be null or empty");
    }
    ...
    private record ExecutionImpl(@NonNull String value) implements SamlPropertyExecution {
        ...
        public void customizeConfiguration(@NonNull SAML2Configuration configuration) {
            configuration.setServiceProviderEntityId(value);
        }
    }
    ...
    public static class DescriptorImpl extends SamlPropertyDescriptor {
        ...
        public String getDisplayName() {
            return "Override Service Provider Entity ID";
        }
