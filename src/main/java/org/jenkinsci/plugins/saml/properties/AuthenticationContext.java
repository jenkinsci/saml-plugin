...
/**
 * Represents the authentication context for SAML authentication.
 * This property allows specifying the authentication context class reference.
 */
public class AuthenticationContext extends SamlProperty {
    private final String value;

    @DataBoundConstructor
    public AuthenticationContext(String value) {
        this.value = value;
    }
    ...
    private record ExecutionImpl(String value) implements SamlPropertyExecution {
        @Override
        public void customizeConfiguration(@NonNull SAML2Configuration configuration) {
            configuration.setAuthnContextClassRefs(List.of(value));
            configuration.setComparisonType("exact");
        }
    }
